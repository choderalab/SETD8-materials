...
# for this mutation only, the clustering returns only one model (1ZKK_C), unclear why - manually make unique_by_clustering
# files in all models

cp files/unique_by_clustering models/KMT5A_HUMAN_D0/KMT5A_HUMAN_1ZKK_A
cp files/unique_by_clustering models/KMT5A_HUMAN_D0/KMT5A_HUMAN_1ZKK_B
cp files/unique_by_clustering models/KMT5A_HUMAN_D0/KMT5A_HUMAN_1ZKK_C
cp files/unique_by_clustering models/KMT5A_HUMAN_D0/KMT5A_HUMAN_1ZKK_D
