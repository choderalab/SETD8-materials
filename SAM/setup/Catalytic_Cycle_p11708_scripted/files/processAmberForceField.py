# from https://github.com/pandegroup/openmm/blob/master/devtools/forcefield-scripts/processAmberForceField.py
# changes: from Julie's script (https://github.com/juliebehr/AURKA_UMN/blob/TPO/fah-prep/phosphorylated/processAmberParameters.py) copy a few lines to add the name of the first
# residue to all atom type numbers - this prevents clashes with the atom type numbers in the protein FF
