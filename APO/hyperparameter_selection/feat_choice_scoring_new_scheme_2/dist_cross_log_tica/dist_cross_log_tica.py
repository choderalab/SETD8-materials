...
splits_train = np.load('/home/rafal.wiewiora/repos/MSM/set8_apo_11707_11709_FINAL/feat_choice_scoring_new_scheme_2/splits_train_distlog.npy')
#splits_test = np.load('/cbio/jclab/home/rafal.wiewiora/repos/MSM_play/set8_apo_11707_11709_FINAL/feat_choice_scoring_new_scheme/splits_test_distlog.npy')

source = pyemma.coordinates.source(list(np.array(glob.glob('/data/chodera/rafal.wiewiora/set8_apo_11707_11709/data_cut_start_noH_stride10_featurized/dist_cross_soft/*/*.npy'))[list(splits_train[split])]))
...
if tica_type == 'kinetic':
    ...
    for i, traj in enumerate(glob.glob('/data/chodera/rafal.wiewiora/set8_apo_11707_11709/data_cut_start_noH_stride10_featurized/dist_cross_soft/*/*.npy')):
        traj = np.load(traj)
