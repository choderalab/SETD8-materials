...
#splits_test = np.load('/cbio/jclab/home/rafal.wiewiora/repos/MSM_play/set8_apo_11707_11709_FINAL/feat_choice_scoring_new_scheme/splits_test_dih.npy')

source = pyemma.coordinates.source(list(np.array(glob.glob('/data/chodera/rafal.wiewiora/set8_apo_11707_11709/data_cut_start_noH_stride10_featurized/dih/*.npy'))[list(splits_train[split])]))
...
for i, traj in enumerate(glob.glob('/data/chodera/rafal.wiewiora/set8_apo_11707_11709/data_cut_start_noH_featurized/data_cut_start_noH_featurized/dih/*.npy')):
    traj = np.load(traj)
