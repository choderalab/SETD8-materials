...
for cluster_no in cluster_nos:
    ...
    for replicate in replicates:
        dtrajs_train = list(np.load('/data/chodera/rafal.wiewiora/set8_apo_11707_11709/dist_full/dtrajs/%d_%d_train.npy' % (cluster_no, replicate)))
        dtrajs_test = list(np.load('/data/chodera/rafal.wiewiora/set8_apo_11707_11709/dist_full/dtrajs/%d_%d_test.npy' % (cluster_no, replicate)))
...
np.save('pyemma_scores_dist', pyemma_scores) 
