for i in range(24): cmd.load('/Users/rafalpwiewiora/repos/MSM/models/1zkk_a.pdb', '%d' % i)

for i in range(24): cmd.load_traj('%d.pdb' % i, state=1)

for i in range(24): cmd.intra_fit('%d' % i)

for i in range(23): cmd.align('%d' % i, '23')
