...
hmm = pyemma.msm.bayesian_hidden_markov_model(dtrajs, 6, lag, connectivity='largest')
...
L, R = hmm.sample_conf('timescales')
np.save('%d/timescales_L' % lag, L)
np.save('%d/timescales_R' % lag, R)
